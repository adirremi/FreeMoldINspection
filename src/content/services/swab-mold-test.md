...
faqs:
  ...
  - question: "When should I choose a swab test instead of a full inspection?"
    answer: "A swab test is ideal when you have a specific, visible spot you want identified quickly and affordably. If you suspect a larger or hidden problem, a comprehensive inspection or air quality test gives a more complete picture."
  - question: "How accurate is a swab mold test?"
    answer: "Swab sampling is a reliable way to identify the mold present on the exact surface tested. Because it targets one spot, we may recommend pairing it with a broader inspection if you are concerned about other areas."
---
...
## How the swab test works

The process is simple and minimally invasive:

- We discuss the specific spot or surface you want tested
- A sterile swab is used to collect a sample from that exact area
...
A swab mold test is ideal when you have a **specific, visible area** you want identified quickly. If the swab confirms mold, we can explain your options and, when appropriate, recommend a broader evaluation such as a comprehensive inspection or indoor air quality test to rule out hidden problems elsewhere.

Whatever the result, you walk away with laboratory-backed facts about the surface you were worried about — and a clear, pressure-free explanation of what to do next. If you are unsure whether a swab test or a full inspection fits your situation, just call us and we will help you choose.
